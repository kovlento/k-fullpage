<template>
    <div class="k-fullpage-container" ref='k-fullpage' @mousewheel='mouseWheelHandle' @DOMMouseScroll='mouseWheelHandle'>
...
export default {
    ...
    methods:{
        ...
        initFullPage(){
            //初始化容器宽高度
            this.isShow=false
            let height = this.$refs['k-fullpage'].clientHeight;
            let width=this.$refs['k-fullpage'].clientWidth;
